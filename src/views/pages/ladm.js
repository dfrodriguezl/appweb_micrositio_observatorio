...
const Imagen = () => {
  ...
  return <Grid item container xs={6} className={estilo}></Grid>;
};
...
const Imagenuml = () => {
  ...
  {
    matches
      ? (estilo = classes.imagen_topmodel)
      : (estilo = classes.imagen_topmodel2);
  }
  return <Grid container className={estilo}></Grid>;
};
        ...
        <Grid container direction="row" xs={8} justifyContent="center" alignItems="center">
          <Grid container xs justifyContent="center">
            <Tooltip title={t("ladm.ladm4")} arrow>
              <Button className={classes.boton + " " + ajustable} target="_blank" href={rarmodelo} download>
          ...
          <Grid container xs justifyContent="center">
            <Tooltip title={t("ladm.ladm5")} arrow>
              <Button className={classes.boton + " " + ajustable} target="_blank" href={imagenmodelo} download>                
                  {t("ladm.ladm5")}
                {/* <DownloadForOfflineRoundedIcon style={{ fill: "white" }} /> */}
              </Button>
            </Tooltip>
