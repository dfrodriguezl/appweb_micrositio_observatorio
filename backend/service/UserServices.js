    ...
    return new Promise((resolver, rechazar) => {
      const r = pool
        ...
        .query(
          ...
          [file.a, file.b, file.c, file.d, file.e, file.f, file.g, file.h, file.i, file.j, file.k, file.l, file.m, file.n, file.o, file.p, file.q, file.r, file.s, file.t, file.u, file.w, file.x, file.y, file.z, file.a26, file.a27, file.a28, filea29, file.a30, file.a31, file.a32, file.a33, file.a34, file.a35, file.a36, file.a37, file.a38 ],
          (error, result) => {
            console.log(error);
            if (error) {
              rechazar(false);
